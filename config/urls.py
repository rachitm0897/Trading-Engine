...
api_patterns = [
    ...
    path("orders/", views.orders), path("orders/manual-quote/", views.manual_order_quote), path("orders/intents/<int:intent_id>/status/", views.manual_order_intent_status), path("orders/<str:internal_id>/detail/", views.orders, {"action":"detail"}), path("orders/<str:internal_id>/", views.orders), path("orders/<str:internal_id>/cancel/", views.orders, {"action":"cancel"}), path("executions/", views.executions), path("reconciliation/", views.reconciliation),
