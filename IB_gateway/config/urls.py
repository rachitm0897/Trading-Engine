...
api=[
 ...
 path("accounts/",views.accounts),path("account-summary/",views.account_summary),path("positions/",views.positions),path("open-orders/",views.open_orders),path("executions/",views.executions),
 path("contracts/qualify/",views.qualify),path("orders/",views.orders),path("orders/<str:internal_id>/",views.orders),path("orders/<str:internal_id>/cancel/",views.cancel),
